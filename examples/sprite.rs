use magnidraw::{Color, Drawer, Engine, Game, Pos, Scale, Sprite};
...
impl Game for SpriteDemo {
    fn setup(&mut self, engine: &mut Engine) {
        ...
        // uniform buffers.
        self.tux = Some(engine.load_sprite(include_bytes!("tux.png")));
        // We can change the background color to make tux stand out a little
        // more.
        engine.set_clear_color(Color::rgb(0.8, 0.7, 0.6));
    }
